    ...
    <Transition appear show={isContactModalOpen} as={Fragment}>
      <Dialog onClose={closeContactModal} initialFocus={emailRef}>
        ...
        <div className="fixed inset-0 flex items-center justify-center lg:p-4 z-50">
          ...
          >
            <DialogPanel className="relative mx-auto flex h-screen w-screen flex-col items-center justify-center bg-white p-10 text-center transition-all lg:h-auto lg:max-w-[450px] lg:items-start lg:rounded-lg lg:text-left">
              ...
              <DialogTitle className="font-heading text-3xl font-bold">Contact</DialogTitle>
              <div
